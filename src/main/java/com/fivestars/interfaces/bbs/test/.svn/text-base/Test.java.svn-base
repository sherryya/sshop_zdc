package com.fivestars.interfaces.bbs.test;
...
public class Test {
	...
	public static void testLogin(){
		...
		Client e = new Client();
		String result = e.uc_user_login("jingzhi", "jingzhi");
...
//		生成同步退出的代码
	...
	public static void testRegister(){
		...
		//setcookie('Example_auth', '', -86400);
//		生成同步退出的代码
		String $returns = uc.uc_user_register("牙在在在", "jingzhit" ,"jingzhti@abc.com" );
