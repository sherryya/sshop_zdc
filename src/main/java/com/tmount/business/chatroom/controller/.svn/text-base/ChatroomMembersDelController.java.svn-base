...
//聊天室成员退出聊天室
@Controller
public class ChatroomMembersDelController extends ControllerBaseByLogin {
	@Autowired
	private ChatroomService chatroomService;
	
	@RequestMapping(value = "ChatroomMembers.Del")
	@Override
	...
	protected void doService(RequestParam requestParam, JsonGenerator responseBodyJson, HttpServletRequest request) throws ShopException, JsonGenerationException, IOException {
		...
		try {
			...
			int ret=chatroomService.delete_chatroom_members(tZdcChatroomMembers);
