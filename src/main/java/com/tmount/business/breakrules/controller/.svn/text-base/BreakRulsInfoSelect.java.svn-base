 ...
 */
@Controller
public class BreakRulsInfoSelect extends ControllerBaseByLogin {
	Logger logger = Logger.getLogger(BreakRulsInfoSelect.class.getName());
	@Autowired
	private BreakRulesService breakRulesService;

	@RequestMapping(value = "BreakRulesSelect.get")
	@Override
	...
	protected void doService(RequestParam requestParam,
		...
		List<TZdcBreakrules> newsRollSub = breakRulesService.selectbreakerInfo(ID.split(","));
