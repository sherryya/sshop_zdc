 ...
 */
@Controller
public class UserFavouriteShopDelete extends ControllerBase {
	@Autowired
	private UserService userService;

	@RequestMapping(value = "user.favourite.shop.delete")
	@Override
	...
	protected void doService(RequestParam requestParam,
		...
		userService.deleteUsFavouriteShop(usFavouriteShopKey);
	}
}
