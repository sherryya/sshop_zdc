...
@Controller
public class GetDeviceSysDataStreamList extends ControllerBasePlatform {
	String json = "";
	...
	protected String doService(RequestParam requestParam) throws ShopException,
		...
		json = GetLaunchInfo.getDeviceSysDataStreamList(params);
	...
	@RequestMapping(value = "devicesysdatastreamlist.get")
	@Override
