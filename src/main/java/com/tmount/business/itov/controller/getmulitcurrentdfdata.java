...
@Controller
public class getmulitcurrentdfdata extends ControllerBasePlatform {
	String json = "";
	@Override
	protected String doService(RequestParam requestParam) throws ShopException,
		...
		json= GetLaunchInfo.getmulitcurrentdfdatastream(params);
		json = URLDecoder.decode(json,"utf-8");
		return json;
	}
	
	@RequestMapping(value = "getmulitcurrentdfdatastream.get")
	@Override
