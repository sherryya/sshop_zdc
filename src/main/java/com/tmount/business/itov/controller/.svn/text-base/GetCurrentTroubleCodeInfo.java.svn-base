...
@Controller
public class GetCurrentTroubleCodeInfo extends ControllerBasePlatform {
	String json = "";
	@Override
	protected String doService(RequestParam requestParam) throws ShopException,
		...
		json= GetLaunchInfo.getCurrentTroubleCodeInfo(params);
	...
	@RequestMapping(value = "currenttroubleCodeInfo.get")
	@Override
