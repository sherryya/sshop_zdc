...
@Controller
public class getsyscansupportedbydevice extends ControllerBasePlatform {
	String json = "";
	@Override
	protected String doService(RequestParam requestParam) throws ShopException,
		...
		json= GetLaunchInfo.getsyscansupportedbydevice(params);
	...
	@RequestMapping(value = "syscansupportedbydevice.get")
	@Override
