...
@Controller
public class GetDevicesInfo extends ControllerBasePlatform {
	String json = "";
	@Override
	protected String doService(RequestParam requestParam) throws ShopException,
		...
		String devicesn = new String (ParamData.getString(requestParam.getBodyNode(), "devicesn"));
		String devicetype = new String (ParamData.getString(requestParam.getBodyNode(),"devicetype"));
		params.put("devicesn", devicesn);
		params.put("devicetype",devicetype);
		json= GetLaunchInfo.getDevicesInfo(params);
	...
	@RequestMapping(value = "deviceinfo.get")
	@Override
