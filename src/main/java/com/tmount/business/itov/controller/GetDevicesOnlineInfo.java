...
@Controller
public class GetDevicesOnlineInfo extends ControllerBasePlatform {
	String json = "";
	@Override
	protected String doService(RequestParam requestParam) throws ShopException,
		...
		json= GetLaunchInfo.getDevicesOnlineInfo(params);
	...
	@RequestMapping(value = "devicesonlineinfo.get")
	@Override
