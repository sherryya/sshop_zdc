...
@Controller
public class Getdevicegrouplistbyappid extends ControllerBasePlatform {
	String json = "";
	@Override
	protected String doService(RequestParam requestParam) throws ShopException,
			JsonGenerationException, IOException {
		json= GetLaunchInfo.getdevicegrouplistbyappid();
	...
	@RequestMapping(value = "devicegrouplistbyappid.get")
	@Override
