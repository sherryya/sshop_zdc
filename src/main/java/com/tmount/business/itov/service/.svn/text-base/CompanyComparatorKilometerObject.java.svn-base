...
public class CompanyComparatorKilometerObject implements Comparator{
	...
	public int compare(Object o1, Object o2) {
		...
		MessageDriverKilometer driverKilometer2=(MessageDriverKilometer)o2;
		   ...
		   //比较开始时间
		String startTime1 = driverKilometer1.getStartTime().replaceAll(":", "").replaceAll("-", "").replaceAll(" ", "");
		String startTime2 = driverKilometer2.getStartTime().replaceAll(":", "").replaceAll("-", "").replaceAll(" ", "");
