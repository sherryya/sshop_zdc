 ...
 */
@Controller
public class Conf_CreateConfController extends ControllerBaseByHttp {
	Logger logger = Logger.getLogger(Conf_CreateConfController.class.getName());
	...
	@RequestMapping(value = "createconf")
	@Override
