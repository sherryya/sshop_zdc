 ...
 *
 */
public class RestAPI_CreateConf {
	public static void main(String[] args) throws KeyManagementException, NoSuchAlgorithmException {
		RestAPI_CreateConf c=new  RestAPI_CreateConf();
		String ret= c.GetAgentCallForwarding("10");
		System.out.println(ret);
	}
	public  String GetAgentCallForwarding( String maxmember) throws NoSuchAlgorithmException, KeyManagementException {
		...
		try {
			...
			String url = (new StringBuilder(hostname)).append(":").append(port)
					     ...
					     .append("/ivr/createconf?sig=").append(signature).append("&maxmember=").append(maxmember).toString();
			...
			if(!JsonUtils.JSON_ENABLE) {
	            ...
	            .append("<CreateConf  ").append("maxmember=\"").append(maxmember).append("\"/>")
	            .append("</Request>").toString();
				System.out.println("RestAPI_CreateConf:"+body);
			}
			System.out.println("RestAPI_CreateConf : request _" + body);
