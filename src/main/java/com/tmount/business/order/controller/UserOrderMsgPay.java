 ...
 */
@Controller
public class UserOrderMsgPay extends ControllerBase {
	@Autowired
	private OrderService orderService;
	
	@RequestMapping(value = "user.order.msg.pay")
	@Override
	...
	protected void doService(RequestParam requestParam,
		...
		//Long payId = orderService.userOrderMsgPay(orderNo, userId, payWayId,
		//		mark, payType, payMoney, payEvkMoney, payOtherId, 0);
		responseBodyJson.writeNumberField("pay_id", 1);
	}
}
